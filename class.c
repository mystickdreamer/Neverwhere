...
int class_ok_race[NUM_RACES][NUM_CLASSES] = {
	/*                NG, Wi,Cl,Ro,Fi,Mo,Pa,So,Dr,Ba,Ra,Bn,Aa,At,Am,As,Bg,Dd,Du,Dw,Ek,Ht,Hw,Lr,Mt,Sd,Th,Ad,Ma,No,Nl,So,   */
	/* Human      */
	{ Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, N, N, N},
	/* Elf        */
	{ Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, N, N, N},
	/* Gnome      */
	{ Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, N, N, N},
	/* Dwarf      */
	{ Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, N, N},
	/* Half Elf   */
	{ Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, N, N, N},
	/* Halfling   */
	{ Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, N, N, N},
	...
	{ Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, N, N, N},
	/* Animal     */
	{ Y, N, N, N, N, N, N, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, N, N, N},
	/* Construct  */
	{ Y, N, N, N, N, N, N, Y, Y, Y, Y, Y, N, Y, N, N, N, Y, N, N, Y, Y, Y, Y, Y, Y, Y, N, N, N},
	/* Demon      */
	{ N, N, N, N, N, N, Y, Y, Y, Y, Y, N, Y, N, N, N, Y, N, N, N, N, N, N, N, N, N, N, N, N},
	/* Dragon     */
	{ Y, N, N, N, N, N, N, Y, Y, Y, Y, Y, N, Y, N, N, N, N, N, N, N, N, N, N, N, N, N, N, N, N},
	/* Fish       */
	{ Y, N, N, N, N, N, N, Y, Y, Y, Y, Y, N, Y, N, N, N, Y, N, N, N, N, N, N, N, N, N, N, N, N},
	/* Giant      */
	{ Y, N, N, N, N, N, N, Y, Y, Y, Y, Y, N, Y, N, N, N, Y, N, N, N, N, N, N, N, N, N, N, N, N},
	/* Goblin     */
	{ Y, N, N, N, N, N, N, Y, Y, Y, Y, Y, N, Y, N, N, N, Y, N, N, N, N, N, N, N, N, N, N, N, N},
...
int class_ok_align[NUM_ALIGNS][NUM_CLASSES] = {
	...
	/* LG */
	{ Y, Y, Y, Y, Y, Y, Y, N, N, Y, N, Y, N, Y, N, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y},
	/* NG */
	{ Y, Y, Y, Y, N, N, Y, Y, Y, Y, Y, Y, Y, Y, N, N, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y},
	/* CG */
	{ Y, Y, Y, Y, N, N, Y, N, Y, Y, Y, Y, Y, Y, N, N, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y},
	/* LN */
	{ Y, Y, Y, Y, Y, N, Y, Y, N, Y, N, Y, N, Y, N, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y},
	/* NN */
	{ Y, Y, Y, Y, N, N, Y, Y, Y, Y, Y, Y, Y, Y, N, N, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y},
	/* CN */
	{ Y, Y, Y, Y, N, N, Y, Y, Y, Y, Y, Y, Y, Y, N, N, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y},
	/* LE */
	{ Y, Y, Y, Y, Y, N, Y, N, N, Y, N, Y, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y},
	/* NE */
	{ Y, Y, Y, Y, N, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y},
	/* CE */
	{ Y, Y, Y, Y, N, N, Y, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y}
};
...
int parse_class(struct char_data *ch, int arg) {
	...
	switch (arg) {
		case 1: chclass = CLASS_NOGUILD;
			break;
		case 2: chclass = CLASS_WIZARD;
			break;
		case 3: chclass = CLASS_CLERIC;
			break;
		case 4: chclass = CLASS_ROGUE;
			break;
		case 5: chclass = CLASS_FIGHTER;
			break;
		case 6: chclass = CLASS_MONK;
			break;
		case 7: chclass = CLASS_PALADIN;
			break;
		case 8: chclass = CLASS_SORCERER;
			break;
		case 9: chclass = CLASS_DRUID;
			break;
		case 10: chclass = CLASS_BARD;
			break;
		case 11: chclass = CLASS_RANGER;
			break;
		case 12: chclass = CLASS_BARBARIAN;
			break;
		default: chclass = CLASS_UNDEFINED;
			break;
	}
...
int class_ok_prestige(struct char_data *ch, int whichclass) {
	...
	switch (whichclass) {
		...
		case CLASS_ARCANE_TRICKSTER:
			/* Any Non-Lawful */
			if (GET_SKILL(ch, SKILL_MAGIC_SEEKING) < 7)
				return FALSE;
			if (GET_SKILL(ch, SKILL_MAGIC_SEEKING) < 7)
				return FALSE;
			if (GET_SKILL(ch, SKILL_MAGIC_TRAVEL) < 7)
				return FALSE;
			/* Ability to cast mage hand and at least one arcane spell of 3rd level or higher */
			/* Knowledge (arcana) 4 ranks. */
			if (GET_SKILL(ch, SKILL_MAGIC_CASTING) < 3)
				return FALSE;
			/* Sneak attack +2d6. */
			return TRUE; /*change this when checks are in */
		case CLASS_ARCHMAGE:
			/* Knowledge (arcana) 15 ranks. */
			if (GET_SKILL(ch, SKILL_MAGIC_CASTING) < 14)
				return FALSE;
			/* Spellcraft 15 ranks. */
			if (GET_SKILL(ch, SKILL_MAGIC_SEEKING) < 14)
				return FALSE;
		...
		case CLASS_ASSASSIN:
			...
			/*if (GET_MURDER(ch) == 0)         
			  return FALSE; */
			if (GET_SKILL(ch, SKILL_MAGIC_ILLUSION) < 4)
				return FALSE;
		...
		case CLASS_BLACKGUARD:
			...
			if (!HAS_FEAT(ch, FEAT_CLEAVE) && !HAS_FEAT(ch, FEAT_IMPROVED_SUNDER))
				return FALSE;
			if (GET_SKILL(ch, SKILL_STEALTH) < 5)
				return FALSE;
			/* Knowledge (religion) 2 ranks */
			if (GET_SKILL(ch, SKILL_MAGIC_DEATH) < 1)
				return FALSE;
			return TRUE;
		case CLASS_DRAGON_DISCIPLE:
			...
			if (GET_SKILL(ch, SKILL_MAGIC_CASTING) < 7)
				return FALSE;
		...
		case CLASS_MYSTIC_THEURGE:
			...
			if (GET_SKILL(ch, SKILL_MAGIC_SEEKING) < 5)
				return FALSE;
			if (GET_SKILL(ch, SKILL_MAGIC_CASTING) < 5)
				return FALSE;
		...
		case CLASS_SHADOWDANCER:
			...
			if (GET_SKILL(ch, SKILL_STEALTH) < 8)
				return FALSE;
			if (GET_SKILL(ch, SKILL_MAGIC_TRAVEL) < 6)
				return FALSE;
...
void roll_real_abils(struct char_data *ch) {
	...
	do {
		 ...
		 * roll. */
	} while (--count && (table[0] < 14 || table[0] > 25));
...
void do_start(struct char_data *ch) {
	...
	//Errbody can use these weapons
	SET_SKILL(ch, SKILL_WEAPON_SMALL_EDGED, 1);
	SET_SKILL(ch, SKILL_WEAPON_MEDIUM_EDGED, 1);
	SET_SKILL(ch, SKILL_WEAPON_HEAVY_EDGED, 1);
	SET_SKILL(ch, SKILL_WEAPON_SMALL_BLUNT, 1);
	SET_SKILL(ch, SKILL_WEAPON_MEDIUM_BLUNT, 1);
	SET_SKILL(ch, SKILL_WEAPON_HEAVY_BLUNT, 1);
	SET_SKILL(ch, SKILL_WEAPON_SHORTBOW, 1);
	SET_SKILL(ch, SKILL_WEAPON_LONGBOW, 1);
	SET_SKILL(ch, SKILL_WEAPON_LIGHT_CROSSBOW, 1);
	SET_SKILL(ch, SKILL_WEAPON_HEAVY_CROSSBOW, 1);
	SET_SKILL(ch, SKILL_WEAPON_LIGHT_THROWN, 1);
	SET_SKILL(ch, SKILL_WEAPON_HEAVY_THROWN, 1);
	//Errbody can use these armors
	SET_SKILL(ch, SKILL_ARMOR_SHIELD, 1);
	SET_SKILL(ch, SKILL_ARMOR_LIGHT, 1);
	SET_SKILL(ch, SKILL_ARMOR_MEDIUM, 1);
	SET_SKILL(ch, SKILL_ARMOR_HEAVY, 1);
	//Errbody can use these skills
	SET_SKILL(ch, SKILL_DODGE, 1);
	SET_SKILL(ch, SKILL_CLIMB, 1);
	SET_SKILL(ch, SKILL_SWIM, 1);
	SET_SKILL(ch, SKILL_PERCEPTION, 1);
	SET_SKILL(ch, SKILL_TRACK, 1);
	SET_SKILL(ch, SKILL_STEALTH, 1);
	SET_SKILL(ch, SKILL_LOCKPICK, 1);
	SET_SKILL(ch, SKILL_DISARM, 1);
	SET_SKILL(ch, SKILL_STEAL, 1);
	SET_SKILL(ch, SKILL_SKIN, 1);
	SET_SKILL(ch, SKILL_FIRSTAID, 1);
	//Errbody can use these Lores
	SET_SKILL(ch, SKILL_LORE_MUSIC, 1);
	SET_SKILL(ch, SKILL_LORE_APPRAISE, 1);
	//Errbody can use magic now
	SET_SKILL(ch, SKILL_MAGIC_CASTING, 1);
	SET_SKILL(ch, SKILL_MAGIC_FIRE, 1);
	SET_SKILL(ch, SKILL_MAGIC_WARDING, 1);
	SET_SKILL(ch, SKILL_MAGIC_AIR, 1);
	SET_SKILL(ch, SKILL_MAGIC_EARTH, 1);
	SET_SKILL(ch, SKILL_MAGIC_WATER, 1);
	SET_SKILL(ch, SKILL_MAGIC_HEXEN, 1);
	SET_SKILL(ch, SKILL_MAGIC_ILLUSION, 1);
	SET_SKILL(ch, SKILL_MAGIC_MUSIC, 1);
	SET_SKILL(ch, SKILL_MAGIC_TRAVEL, 1);
	SET_SKILL(ch, SKILL_MAGIC_HEALING, 1);
	SET_SKILL(ch, SKILL_MAGIC_DREAM, 1);
	SET_SKILL(ch, SKILL_MAGIC_SEEKING, 1);
	SET_SKILL(ch, SKILL_MAGIC_THOUGHT, 1);
	SET_SKILL(ch, SKILL_MAGIC_CATALYSM, 1);
	SET_SKILL(ch, SKILL_MAGIC_DEATH, 1);
	SET_SKILL(ch, SKILL_MAGIC_VOID, 1);
	//Craft Skills
	SET_SKILL(ch, SKILL_CRAFT_MINING, 1);
	SET_SKILL(ch, SKILL_CRAFT_FORAGE, 1);
	SET_SKILL(ch, SKILL_CRAFT_FORESTRY, 1);
	SET_SKILL(ch, SKILL_CRAFT_COOKING, 1);
	SET_SKILL(ch, SKILL_CRAFT_BLACKSMITHING, 1);
	SET_SKILL(ch, SKILL_CRAFT_TAILOR, 1);
	SET_SKILL(ch, SKILL_CRAFT_TANNING, 1);
	SET_SKILL(ch, SKILL_CRAFT_JEWELCRAFT, 1);
	SET_SKILL(ch, SKILL_CRAFT_WOODWORKING, 1);
	SET_SKILL(ch, SKILL_CRAFT_TINKER, 1);
	SET_SKILL(ch, SKILL_CRAFT_FORGING, 1);
	SET_SKILL(ch, SKILL_CRAFT_ALCHEMY, 1);
	SET_SKILL(ch, SKILL_CRAFT_ENCHANT, 1);
	SET_SKILL(ch, SKILL_CRAFT_RUNECRAFT, 1);

	/* Derived from the SRD under OGL, see ../doc/srd.txt for information */
	switch (GET_RACE(ch)) {
		case RACE_HUMAN:
			SET_SKILL(ch, SKILL_LANG_COMMON, 1);
			SET_SKILL(ch, SKILL_WEAPON_SMALL_EDGED, 5);
			SET_SKILL(ch, SKILL_WEAPON_MEDIUM_EDGED, 5);
			SET_SKILL(ch, SKILL_WEAPON_HEAVY_EDGED, 5);
			SET_SKILL(ch, SKILL_WEAPON_SMALL_BLUNT, 5);
			SET_SKILL(ch, SKILL_WEAPON_MEDIUM_BLUNT, 5);
			SET_SKILL(ch, SKILL_WEAPON_HEAVY_BLUNT, 5);
			SET_SKILL(ch, SKILL_WEAPON_SHORTBOW, 5);
			SET_SKILL(ch, SKILL_WEAPON_LONGBOW, 5);
			SET_SKILL(ch, SKILL_WEAPON_LIGHT_CROSSBOW, 5);
			SET_SKILL(ch, SKILL_WEAPON_HEAVY_CROSSBOW, 5);
			SET_SKILL(ch, SKILL_WEAPON_LIGHT_THROWN, 5);
			SET_SKILL(ch, SKILL_WEAPON_HEAVY_THROWN, 5);
			//Errbody can use these armors
			SET_SKILL(ch, SKILL_ARMOR_SHIELD, 5);
			SET_SKILL(ch, SKILL_ARMOR_LIGHT, 5);
			SET_SKILL(ch, SKILL_ARMOR_MEDIUM, 5);
			SET_SKILL(ch, SKILL_ARMOR_HEAVY, 5);
			//Errbody can use these skills
			SET_SKILL(ch, SKILL_DODGE, 5);
			SET_SKILL(ch, SKILL_CLIMB, 5);
			SET_SKILL(ch, SKILL_SWIM, 5);
			SET_SKILL(ch, SKILL_PERCEPTION, 5);
			SET_SKILL(ch, SKILL_TRACK, 5);
			SET_SKILL(ch, SKILL_STEALTH, 5);
			SET_SKILL(ch, SKILL_LOCKPICK, 5);
			SET_SKILL(ch, SKILL_DISARM, 5);
			SET_SKILL(ch, SKILL_STEAL, 5);
			SET_SKILL(ch, SKILL_SKIN, 5);
			SET_SKILL(ch, SKILL_FIRSTAID, 5);
			//Errbody can use these Lores
			SET_SKILL(ch, SKILL_LORE_MUSIC, 5);
			SET_SKILL(ch, SKILL_LORE_APPRAISE, 5);
			//Errbody can use magic now
			SET_SKILL(ch, SKILL_MAGIC_CASTING, 5);
			SET_SKILL(ch, SKILL_MAGIC_FIRE, 5);
			SET_SKILL(ch, SKILL_MAGIC_WARDING, 5);
			SET_SKILL(ch, SKILL_MAGIC_AIR, 5);
			SET_SKILL(ch, SKILL_MAGIC_EARTH, 5);
			SET_SKILL(ch, SKILL_MAGIC_WATER, 5);
			SET_SKILL(ch, SKILL_MAGIC_HEXEN, 5);
			SET_SKILL(ch, SKILL_MAGIC_ILLUSION, 5);
			SET_SKILL(ch, SKILL_MAGIC_MUSIC, 5);
			SET_SKILL(ch, SKILL_MAGIC_TRAVEL, 5);
			SET_SKILL(ch, SKILL_MAGIC_HEALING, 5);
			SET_SKILL(ch, SKILL_MAGIC_DREAM, 5);
			SET_SKILL(ch, SKILL_MAGIC_SEEKING, 5);
			SET_SKILL(ch, SKILL_MAGIC_THOUGHT, 5);
			SET_SKILL(ch, SKILL_MAGIC_CATALYSM, 5);
			SET_SKILL(ch, SKILL_MAGIC_DEATH, 5);
			SET_SKILL(ch, SKILL_MAGIC_VOID, 5);
			//Craft Skills
			SET_SKILL(ch, SKILL_CRAFT_MINING, 5);
			SET_SKILL(ch, SKILL_CRAFT_FORAGE, 5);
			SET_SKILL(ch, SKILL_CRAFT_FORESTRY, 5);
			SET_SKILL(ch, SKILL_CRAFT_COOKING, 5);
			SET_SKILL(ch, SKILL_CRAFT_BLACKSMITHING, 5);
			SET_SKILL(ch, SKILL_CRAFT_TAILOR, 5);
			SET_SKILL(ch, SKILL_CRAFT_TANNING, 5);
			SET_SKILL(ch, SKILL_CRAFT_JEWELCRAFT, 5);
			SET_SKILL(ch, SKILL_CRAFT_WOODWORKING, 5);
			SET_SKILL(ch, SKILL_CRAFT_TINKER, 5);
			SET_SKILL(ch, SKILL_CRAFT_FORGING, 5);
			SET_SKILL(ch, SKILL_CRAFT_ALCHEMY, 5);
			SET_SKILL(ch, SKILL_CRAFT_ENCHANT, 5);
			SET_SKILL(ch, SKILL_CRAFT_RUNECRAFT, 5);
			break;
		case RACE_ELF:
			SET_BIT_AR(AFF_FLAGS(ch), AFF_LOW_LIGHT);
			SET_SKILL(ch, SKILL_LANG_COMMON, 1);
			SET_SKILL(ch, SKILL_LANG_ELVEN, 1);
			SET_SKILL(ch, SKILL_MAGIC_SEEKING, 10);
			SET_SKILL(ch, SKILL_WEAPON_LONGBOW, 15);
			SET_SKILL(ch, SKILL_WEAPON_SMALL_EDGED, 5);
			break;
		case RACE_HALF_ELF:
			SET_BIT_AR(AFF_FLAGS(ch), AFF_LOW_LIGHT);
		...
		case RACE_GNOME:
			...
			SET_SKILL(ch, SKILL_STEALTH, 20);
			SET_SKILL(ch, SKILL_MAGIC_ILLUSION, 15);
			break;
		case RACE_DWARF:
			SET_BIT_AR(AFF_FLAGS(ch), AFF_INFRAVISION);
			SET_SKILL(ch, SKILL_LANG_COMMON, 1);
			SET_SKILL(ch, SKILL_LANG_DWARVEN, 1);
			SET_SKILL(ch, SKILL_WEAPON_HEAVY_EDGED, 10);
			SET_SKILL(ch, SKILL_MAGIC_WARDING, 10);
			break;
		case RACE_HALF_ORC:
			SET_BIT_AR(AFF_FLAGS(ch), AFF_INFRAVISION);
		...
		case RACE_HALFLING:
			...
			SET_SKILL(ch, SKILL_LANG_COMMON, 1);
			SET_SKILL(ch, SKILL_STEALTH, 20);
			SET_SKILL(ch, SKILL_CRAFT_COOKING, 15);
			break;
		default:
			SET_SKILL(ch, SKILL_LANG_COMMON, 1);
			break;
...
/*	skill_class(SKILL_CRAFT_CRAFT_ALCHEMY, CLASS_WIZARD, SKLEARN_CLASS);
 ...
 */
	/* MONKS */
	skill_class(SKILL_CLIMB, CLASS_MONK, SKLEARN_CANT);
...
*/
	/* BARDS */
	skill_class(SKILL_LORE_APPRAISE, CLASS_BARD, SKLEARN_CLASS);
...
*/
	/* DRUIDS */
	skill_class(SKILL_CLIMB, CLASS_DRUID, SKLEARN_CLASS);
