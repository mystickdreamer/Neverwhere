...
feato(FEAT_BLIND_FIGHT, "blind fighting", FALSE, TRUE, FALSE); 
...
feato(FEAT_IMPROVED_TRIP, "improved trip", FALSE, TRUE, FALSE);
...
feato(FEAT_MOBILITY, "mobility", FALSE, TRUE, FALSE);
...
feato(FEAT_EVASION, "evasion", FALSE, FALSE, FALSE);
feato(FEAT_IMPROVED_EVASION, "improved evasion", FALSE, FALSE, FALSE);
