...
void mag_assign_spells(void)
{
   ...
   */
  skillo(SKILL_MAGIC_CATALYSM, "use magic device", SKFLAG_CHAMOD | SKFLAG_NEEDTRAIN);
  skillo(SKILL_DODGE, "tumble", SKFLAG_DEXMOD | SKFLAG_NEEDTRAIN | SKFLAG_ARMORALL);
  ...
  skillo(SKILL_STEALTH, "bluff", SKFLAG_CHAMOD);
  skillo(SKILL_CLIMB, "climb", SKFLAG_STRMOD | SKFLAG_ARMORALL);
  //skillo(SKILL_CONCENTRATION, "concentration", SKFLAG_CONMOD);
  skillo(SKILL_MAGIC_SEEKING, "decipher script", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
  skillo(SKILL_PERCEPTION, "spot", SKFLAG_WISMOD);
  ...
  skillo(SKILL_PERCEPTION, "listen", SKFLAG_WISMOD);
  ...
  skillo(SKILL_LOCKPICK, "open lock", SKFLAG_DEXMOD | SKFLAG_NEEDTRAIN | SKFLAG_ARMORBAD);
  //skillo(SKILL_RIDE, "ride", SKFLAG_DEXMOD | SKFLAG_ARMORBAD);
  skillo(SKILL_PERCEPTION, "sense motive", SKFLAG_WISMOD);
  skillo(SKILL_PERCEPTION, "search", SKFLAG_INTMOD);
  skillo(SKILL_STEALTH, "move silently", SKFLAG_DEXMOD | SKFLAG_ARMORALL);
  skillo(SKILL_MAGIC_SEEKING, "spellcraft", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
  skillo(SKILL_STEAL, "sleight of hand", SKFLAG_DEXMOD | SKFLAG_ARMORALL);
  skillo(SKILL_SWIM, "swim", SKFLAG_STRMOD | SKFLAG_ARMORBAD);
  //skillo(SKILL_USE_ROPE, "use rope", SKFLAG_CHAMOD | SKFLAG_NEEDTRAIN);
  skillo(SKILL_TRACK, "track", SKFLAG_CHAMOD | SKFLAG_NEEDTRAIN);
