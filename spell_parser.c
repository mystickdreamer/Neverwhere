	...
	if (IS_SET(SINFO.routines, MAG_MANUAL))
		switch (spellnum) {
			...
			case SPELL_PORTAL: MANUAL_SPELL(spell_portal);
				break;
			case ART_ABUNDANT_STEP: MANUAL_SPELL(art_abundant_step);
				break;
		}
...
void mag_assign_spells(void) {
	...
	spello(SPELL_PARALYZE, "paralyze", 25, 10, 1, POS_STANDING,
	 ...
	 */
	skillo(SKILL_WEAPON_SMALL_EDGED, "small edged", SKFLAG_DEXMOD);
	skillo(SKILL_WEAPON_MEDIUM_EDGED, "medium edged", SKFLAG_STRMOD);
	skillo(SKILL_WEAPON_HEAVY_EDGED, "heavy edged", SKFLAG_STRMOD);
	skillo(SKILL_WEAPON_SMALL_BLUNT, "small blunt", SKFLAG_STRMOD);
	skillo(SKILL_WEAPON_MEDIUM_BLUNT, "medium blunt", SKFLAG_STRMOD);
	...
	skillo(SKILL_WEAPON_BACKSTAB, "backstab", SKFLAG_DEXMOD);
	
	skillo(SKILL_ARMOR_SHIELD, "shield", SKFLAG_STRMOD);
	skillo(SKILL_ARMOR_CLOTH, "cloth armor", SKFLAG_INTMOD);
	skillo(SKILL_ARMOR_LIGHT, "light armor", SKFLAG_STRMOD);
	skillo(SKILL_ARMOR_MEDIUM, "medium armor", SKFLAG_STRMOD);
	skillo(SKILL_ARMOR_HEAVY, "heavy armor", SKFLAG_STRMOD);
	
	skillo(SKILL_DODGE, "dodge", SKFLAG_DEXMOD);
	skillo(SKILL_CLIMB, "climb", SKFLAG_DEXMOD);
	...
	skillo(SKILL_LORE_SCHOLARSHIP, "scholarship", SKFLAG_INTMOD);
	skillo(SKILL_LORE_MUSIC, "music", SKFLAG_CHAMOD);
	skillo(SKILL_LORE_APPRAISE, "appraise", SKFLAG_INTMOD);
	
	skillo(SKILL_MAGIC_CASTING, "casting", SKFLAG_INTMOD);
	skillo(SKILL_MAGIC_FIRE, "fire", SKFLAG_INTMOD);
	skillo(SKILL_MAGIC_WARDING, "warding", SKFLAG_INTMOD);
	skillo(SKILL_MAGIC_AIR, "air", SKFLAG_INTMOD);
	skillo(SKILL_MAGIC_EARTH, "earth", SKFLAG_INTMOD);
	...
	skillo(SKILL_MAGIC_SEEKING, "seeking", SKFLAG_INTMOD);
	skillo(SKILL_MAGIC_THOUGHT, "thought", SKFLAG_INTMOD);
	skillo(SKILL_MAGIC_CATALYSM, "catalysm", SKFLAG_INTMOD);
	skillo(SKILL_MAGIC_DEATH, "death", SKFLAG_INTMOD);
	skillo(SKILL_MAGIC_VOID, "void", SKFLAG_INTMOD);
	...
	skillo(SKILL_CRAFT_JEWELCRAFT, "jewelcraft", SKFLAG_DEXMOD);
	skillo(SKILL_CRAFT_WOODWORKING, "woodworking", SKFLAG_STRMOD);
	skillo(SKILL_CRAFT_TINKER, "tinker", SKFLAG_DEXMOD);
	skillo(SKILL_CRAFT_FORGING, "forging", SKFLAG_STRMOD);
	skillo(SKILL_CRAFT_ALCHEMY, "alchemy", SKFLAG_INTMOD);
	skillo(SKILL_CRAFT_ENCHANT, "enchant", SKFLAG_INTMOD);
	skillo(SKILL_CRAFT_RUNECRAFT, "runecraft", SKFLAG_INTMOD);
	
	skillo(SKILL_HANDLE_ANIMAL, "handle animal", SKFLAG_INTMOD);
	...
	skillo(SKILL_LANG_ORC, "orcish language", 0);
	set_skill_type(SKILL_LANG_ORC, SKTYPE_SKILL | SKTYPE_LANG);
	skillo(SKILL_LANG_DRUIDIC, "druid language", 0);
	set_skill_type(SKILL_LANG_DRUIDIC, SKTYPE_SKILL | SKTYPE_LANG);
	skillo(SKILL_LANG_HALFLING, "halfling language", 0);
	set_skill_type(SKILL_LANG_HALFLING, SKTYPE_SKILL | SKTYPE_LANG);
	skillo(SKILL_LANG_DRACONIC, "draconic language", 0);
	set_skill_type(SKILL_LANG_DRACONIC, SKTYPE_SKILL | SKTYPE_LANG);
	//skillo(SKILL_KNOW_ARCANA, "arcana knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
	//skillo(SKILL_KNOW_ARCHITECTURE, "architecture knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
	//skillo(SKILL_KNOW_DUNGEONEERING, "dungeoneering knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
	//skillo(SKILL_KNOW_GEOGRAPHY, "geography knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
	//skillo(SKILL_KNOW_HISTORY, "history knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
	//skillo(SKILL_KNOW_LOCAL, "local knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
	//skillo(SKILL_KNOW_NATURE, "nature knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
	//skillo(SKILL_KNOW_NOBILITY, "nobility knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
	//skillo(SKILL_KNOW_RELIGION, "religion knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
	//skillo(SKILL_KNOW_PLANES, "planes knowledge", SKFLAG_INTMOD | SKFLAG_NEEDTRAIN);
}
