...
#define GET_EXP(ch)			((ch)->exp) //Maybe I can use this for guild exp for completing missions

//Weapon
#define GET_SMALL_EDGED(ch)		((ch)->small_edged)
#define GET_MEDIUM_EDGED(ch)		((ch)->medium_edged)
#define GET_HEAVY_EDGED(ch)		((ch)->heavy_edged)
#define GET_SMALL_BLUNT(ch)		((ch)->small_blunt)
#define GET_MEDIUM_BLUNT(ch)		((ch)->medium_blunt)
#define GET_HEAVY_BLUNT(ch)		((ch)->heavy_blunt)
#define GET_SHORTBOW(ch)		((ch)->shortbow)
#define GET_LONGBOW(ch)			((ch)->longbow)
#define GET_LIGHT_CROSSBOW(ch)		((ch)->light_crossbow)
#define GET_HEAVY_CROSSBOW(ch)		((ch)->heavy_crossbow)
#define GET_POLEARM(ch)			((ch)->polearm)
#define GET_LIGHT_THROWN(ch)		((ch)->light_thrown)
#define GET_HEAVY_THROWN(ch)		((ch)->heavy_thrown)
#define GET_BACKSTAB(ch)		((ch)->backstab)
//Armor 
#define GET_SKILLSHIELD(ch)		((ch)->skillshield)
#define GET_CLOTHARMOR(ch)		((ch)->clotharmor)
#define GET_LIGHTARMOR(ch)		((ch)->lightarmor)
#define GET_MEDIUMARMOR(ch)		((ch)->mediumarmor)
#define GET_HEAVYARMOR(ch)		((ch)->heavyarmor)
//Survival Skill 
#define GET_DODGE(ch)			((ch)->dodge)
#define GET_CLIMB(ch)			((ch)->climb)
#define GET_SWIM(ch)			((ch)->swim)
#define GET_PERCEPTION(ch)		((ch)->perception)
#define GET_TRACK(ch)			((ch)->track)
#define GET_STEALTH(ch)			((ch)->stealth)
#define GET_LOCKPICK(ch)		((ch)->lockpick)
#define GET_DISARM(ch)			((ch)->disarm)
#define GET_STEAL(ch)			((ch)->steal)
#define GET_SKIN(ch)			((ch)->skin)
#define GET_FIRSTAID(ch)		((ch)->firstaid)
//Lore Skill 
#define GET_SCHOLARSHIP(ch)		((ch)->scholarship)
#define GET_APPRAISE(ch)		((ch)->appraise)
//Magic Skill 
#define GET_CASTING(ch)			((ch)->casting)
#define GET_FIRE(ch)			((ch)->fire)
#define GET_WARDING(ch)			((ch)->warding)
#define GET_AIR(ch)			((ch)->air)
#define GET_EARTH(ch)			((ch)->earth)
#define GET_WATER(ch)			((ch)->water)
#define GET_HEXEN(ch)			((ch)->hexen)
#define GET_ILLUSION(ch)		((ch)->illusion)
#define GET_MUSIC(ch)			((ch)->music)
#define GET_TRAVEL(ch)			((ch)->travel)
#define GET_HEALING(ch)			((ch)->healing)
#define GET_DREAM(ch)			((ch)->dream)
#define GET_SEEKING(ch)			((ch)->seeking)
#define GET_THOUGHT(ch)			((ch)->thought)
#define GET_CATALYSM(ch)		((ch)->catalysm)
#define GET_DEATH(ch)			((ch)->death)
#define GET_VOID(ch)			((ch)->void)
//Crafting skills	
#define GET_MINING(ch)			((ch)->mining)
#define GET_FORAGE(ch)			((ch)->forage)
#define GET_FORESTRY(ch)		((ch)->forestry)
#define GET_COOKING(ch)			((ch)->cooking)
#define GET_BLACKSMITHING(ch)		((ch)->blacksmithing)
#define GET_TAILOR(ch)			((ch)->tailor)
#define GET_JEWELCRAFT(ch)		((ch)->jewelcraft)
#define GET_WOODWORKING(ch)		((ch)->woodworking)
#define GET_FORGING(ch)			((ch)->forging)
#define GET_ALCHEMY(ch)			((ch)->alchemy)
#define GET_ENCHANT(ch)			((ch)->enchant)
#define GET_RUNECRAFT(ch)		((ch)->runecraft)
#define GET_TANNING(ch)			((ch)->tanning)
#define GET_TINKERING(ch)		((ch)->tinkering)

//Weapon exp
#define GET_SMALL_EDGED_EXP(ch)		((ch)->small_edged_exp)
#define GET_MEDIUM_EDGED_EXP(ch)	((ch)->medium_edged_exp)
#define GET_HEAVY_EDGED_EXP(ch)		((ch)->heavy_edged_exp)
#define GET_SMALL_BLUNT_EXP(ch)		((ch)->small_blunt_exp)
#define GET_MEDIUM_BLUNT_EXP(ch)	((ch)->medium_blunt_exp)
#define GET_HEAVY_BLUNT_EXP(ch)		((ch)->heavy_blunt_exp)
#define GET_SHORTBOW_EXP(ch)		((ch)->shortbow_exp)
#define GET_LONGBOW_EXP(ch)		((ch)->longbow_exp)
#define GET_LIGHT_CROSSBOW_EXP(ch)	((ch)->light_crossbow_exp)
#define GET_HEAVY_CROSSBOW_EXP(ch)	((ch)->heavy_crossbow_exp)
#define GET_POLEARM_EXP(ch)		((ch)->polearm_exp)
#define GET_LIGHT_THROWN_EXP(ch)	((ch)->light_thrown_exp)
#define GET_HEAVY_THROWN_EXP(ch)	((ch)->heavy_thrown_exp)
#define GET_BACKSTAB_EXP(ch)		((ch)->backstab_exp)
//Armor exp
#define GET_SKILLSHIELD_EXP(ch)		((ch)->skillshield_exp)
#define GET_CLOTHARMOR_EXP(ch)		((ch)->clotharmor_exp)
#define GET_LIGHTARMOR_EXP(ch)		((ch)->lightarmor_exp)
#define GET_MEDIUMARMOR_EXP(ch)		((ch)->mediumarmor_exp)
#define GET_HEAVYARMOR_EXP(ch)		((ch)->heavyarmor_exp)
//Survival Skill Exp
#define GET_DODGE_EXP(ch)		((ch)->dodge_exp)
#define GET_CLIMB_EXP(ch)		((ch)->climb_exp)
#define GET_SWIM_EXP(ch)		((ch)->swim_exp)
#define GET_PERCEPTION_EXP(ch)		((ch)->perception_exp)
#define GET_TRACK_EXP(ch)		((ch)->track_exp)
#define GET_STEALTH_EXP(ch)		((ch)->stealth_exp)
#define GET_LOCKPICK_EXP(ch)		((ch)->lockpick_exp)
#define GET_DISARM_EXP(ch)		((ch)->disarm_exp)
#define GET_STEAL_EXP(ch)		((ch)->steal_exp)
#define GET_SKIN_EXP(ch)		((ch)->skin_exp)
#define GET_FIRSTAID_EXP(ch)		((ch)->firstaid_exp)
//Lore Skill Exp
#define GET_SCHOLARSHIP_EXP(ch)		((ch)->scholarship_exp)
#define GET_APPRAISE_EXP(ch)		((ch)->appraise_exp)
//Magic Skill Exp
#define GET_CASTING_EXP(ch)		((ch)->casting_exp)
#define GET_FIRE_EXP(ch)		((ch)->fire_exp)
#define GET_WARDING_EXP(ch)		((ch)->warding_exp)
#define GET_AIR_EXP(ch)			((ch)->air_exp)
#define GET_EARTH_EXP(ch)		((ch)->earth_exp)
#define GET_WATER_EXP(ch)		((ch)->water_exp)
#define GET_HEXEN_EXP(ch)		((ch)->hexen_exp)
#define GET_ILLUSION_EXP(ch)		((ch)->illusion_exp)
#define GET_MUSIC_EXP(ch)		((ch)->music_exp)
#define GET_TRAVEL_EXP(ch)		((ch)->travel_exp)
#define GET_HEALING_EXP(ch)		((ch)->healing_exp)
#define GET_DREAM_EXP(ch)		((ch)->dream_exp)
#define GET_SEEKING_EXP(ch)		((ch)->seeking_exp)
#define GET_THOUGHT_EXP(ch)		((ch)->thought_exp)
#define GET_CATALYSM_EXP(ch)		((ch)->catalysm_exp)
#define GET_DEATH_EXP(ch)		((ch)->death_exp)
#define GET_VOID_EXP(ch)		((ch)->void_exp)
//Crafting skills Exp
#define GET_MINING_EXP(ch)		((ch)->mining_exp)
#define GET_FORAGE_EXP(ch)		((ch)->forage_exp)
#define GET_FORESTRY_EXP(ch)		((ch)->forestry_exp)
#define GET_COOKING_EXP(ch)		((ch)->cooking_exp)
#define GET_BLACKSMITHING_EXP(ch)	((ch)->blacksmithing_exp)
#define GET_TAILOR_EXP(ch)		((ch)->tailor_exp)
#define GET_JEWELCRAFT_EXP(ch)		((ch)->jewelcraft_exp)
#define GET_WOODWORKING_EXP(ch)		((ch)->woodworking_exp)
#define GET_FORGING_EXP(ch)		((ch)->forging_exp)
#define GET_ALCHEMY_EXP(ch)		((ch)->alchemy_exp)
#define GET_ENCHANT_EXP(ch)		((ch)->enchant_exp)
#define GET_RUNECRAFT_EXP(ch)		((ch)->runecraft_exp)
#define GET_TANNING_EXP(ch)		((ch)->tanning_exp)
#define GET_TINKERING_EXP(ch)		((ch)->tinkering_exp)
...
//#define GET_SKILL_NAME(ch, i)		(spell_info[i].name)
