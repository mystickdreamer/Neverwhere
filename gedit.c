...
void gedit_setup_new(struct descriptor_data *d)
{
	...
	G_NO_GOLD(guilddata) = strdup("%s Sorry, but I'm gonna need more gold first.");
...
void gedit_select_lang_menu(struct descriptor_data *d)
{
  ...
  write_to_output(d, "Languages known:\r\n");
