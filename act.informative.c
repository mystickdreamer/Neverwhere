...
ACMD(do_score) {
	...
	send_to_char(ch, "@rSize@n: @y%s@n @rHeight@n: @y%dcm@n @rWeight@n: @y%dkg@n\r\n", size_names[get_size(ch)], GET_HEIGHT(ch), GET_WEIGHT(ch));
