...
#define CLASS_ARCANE_TRICKSTER  13
#define CLASS_ARCHMAGE          14
#define CLASS_ASSASSIN          15
#define CLASS_BLACKGUARD        16
#define CLASS_DRAGON_DISCIPLE   17
#define CLASS_DUELIST           18
#define CLASS_DWARVEN_DEFENDER  19
#define CLASS_ELDRITCH_KNIGHT   20
#define CLASS_HIEROPHANT        21
#define CLASS_HORIZON_WALKER    22
#define CLASS_LOREMASTER        23
#define CLASS_MYSTIC_THEURGE    24
#define CLASS_SHADOWDANCER      25
#define CLASS_THAUMATURGIST     26
#define CLASS_NPC_EXPERT	27
#define CLASS_NPC_ADEPT		28
#define CLASS_NPC_COMMONER	29
#define CLASS_NPC_ARISTOCRAT	30
#define CLASS_NPC_WARRIOR	31
...
struct char_data {
	...
	int small_edged_exp;
	int medium_edged;
	int medium_edged_exp;
	int heavy_edged;
	int heavy_edged_exp;
	int small_blunt;
	int small_blunt_exp;
	int medium_blunt;
	int medium_blunt_exp;
	int heavy_blunt;
	int heavy_blunt_exp;
	int shortbow;
	int shortbow_exp;
	...
	int longbow_exp;
	int light_crossbow;
	int light_crossbow_exp;
	int heavy_crossbow;
	int heavy_crossbow_exp;
	int polearm;
	int polearm_exp;
	int light_thrown;
